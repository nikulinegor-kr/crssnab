...
КРИТИЧЕСКОЕ ПРАВИЛО 1 — ФИЛЬТРАЦИЯ РАБОТ:

Каждую строку классифицируй как MATERIAL или WORK.

WORK (НЕ добавлять) — строка содержит ДЕЙСТВИЕ/ГЛАГОЛ:
- устройство, разработка, восстановление, планировка, уплотнение
- нарезка, монтаж, демонтаж, разборка, укладка, установка
- подготовка, срезка, засыпка, обратная засыпка
- прокладка, пробивка, заделка, окраска, грунтование
- Любое другое отглагольное существительное описывающее ПРОЦЕСС

MATERIAL (добавлять) — строка описывает ВЕЩЕСТВО/ИЗДЕЛИЕ:
- щебень, песок, бетон, раствор, асфальтобетон, грунт
- геотекстиль, геомембрана, геосетка, плитка, бордюр
- арматура, труба, профиль, лист, уголок, швеллер
- краска, мастика, праймер, битум, эмульсия
- Любой конкретный строительный материал

Правила определения:
- Если строка НАЧИНАЕТСЯ с глагола/действия → WORK (даже если упоминает материал)
  Пример: "Устройство основания из щебня" → WORK (это работа, не материал)
- Если строка НАЧИНАЕТСЯ с существительного-материала → MATERIAL
  Пример: "Щебень фр. 20-40" → MATERIAL
- Единицы м², м³, км — проверять контекст: "Планировка территории, м²" → WORK

КОНТРОЛЬ: в итоге НЕ ДОЛЖНО быть строк со словами: устройство, разработка, планировка, восстановление, уплотнение, нарезка, монтаж.
...
КОНТРОЛЬ КАЧЕСТВА:
В итоговом результате НЕ ДОЛЖНО быть строк со словами "Конструкция", "Тип N", "устройство", "разработка", "планировка" в поле name.\n`
        : `\n⚠️ ТИП ДОКУМЕНТА: ${typeLabel}
