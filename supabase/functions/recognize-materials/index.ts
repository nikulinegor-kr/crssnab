...
═══════════════════════════════════════════════
ЭТАП 6 — ПРИВЯЗКА ГОСТ И МАРКИ СТАЛИ (КРИТИЧЕСКИ ВАЖНО!)
═══════════════════════════════════════════════

Для КАЖДОГО материала найди в документе соответствующий ГОСТ и марку стали:

1. Ищи ГОСТ в заголовках таблицы, в колонке материала, в примечаниях, в подписях к таблице
2. Если ГОСТ указан в шапке таблицы для группы материалов — применяй его ко ВСЕМ материалам этой группы
3. Если марка стали указана рядом с классом арматуры (например "A400 сталь 25Г2С") — включай в type_mark
4. Каждый материал должен иметь СВОЙ правильный ГОСТ:
   - Арматура A240/A400/A500 → ищи ГОСТ 34028, ГОСТ 5781
   - Трубы → ищи ГОСТ 10704, ГОСТ 3262, ГОСТ 8732
   - Прокат полоса → ищи ГОСТ 103
   - Швеллер → ищи ГОСТ 8240
   - Уголок → ищи ГОСТ 8509, ГОСТ 8510
   - Лист → ищи ГОСТ 19903
5. НЕ оставляй type_mark пустым если ГОСТ есть где-то в документе
6. Формат type_mark: "{ГОСТ} {марка стали}" — например: "ГОСТ 34028-2016 25Г2С"
...
- НЕ используй название строки (Водосброс, Плита и т.п.) как наименование — это НЕ материал
...
- ИГНОРИРУЙ чертежи, схемы, размеры на рисунках, бетон, объемы
- Если единицы м²/м³/пог.м без признаков металла — это работы, ИГНОРИРУЙ
