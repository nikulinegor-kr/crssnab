...
1. АРМАТУРА (содержит "A240", "A400", "A500", "Ø" без "×"):
   ...
   type_mark = ГОСТ + марка стали если указана
...
2. ТРУБЫ (содержит "Тр.", "Труба", или "Ø{число}×{число}"):
   ...
   type_mark = ГОСТ трубы + марка стали
...
- Если в таблице несколько ГОСТов — привязывай материал к СВОЕМУ ГОСТу
