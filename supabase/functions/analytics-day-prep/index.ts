...
2. Каждая заявка/счёт/объект — отдельным пунктом маркированного списка. Формат пункта:
   - **[№{number} — {description}](/requests/{id})**
...
4. Если данных по разделу нет — коротко напиши «Нет» и пропусти раздел, не выдумывай.
5. Все суммы форматируй с разделителем тысяч и «₽».
6. Пиши только на русском, Markdown.
