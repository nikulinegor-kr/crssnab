...
Для КАЖДОГО сотрудника из массива \`employees\` — отдельный подраздел \`### {name}\` со следующими блоками (если пусто — не выводи). Каждая ссылка строго в формате \`[{description}](/requests/{id})\`:
- **В работе:** {in_work} заявок
- **Аварийные:** список заявок со ссылками
- **Просроченные:** список заявок с днями просрочки и ссылками
- **Ожидают решения:** список заявок со ссылками
- **Счета на согласовании / к оплате:** список заявок с суммами и ссылками
