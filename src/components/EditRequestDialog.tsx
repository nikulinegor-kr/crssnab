  ...
  const refreshFromServer = useCallback(async () => {
    ...
    if (data) {
      form.reset({
        ...
        amount: data.amount ?? null,
        invoice_number_2: (data as any).invoice_number_2 || "",
        amount_2: (data as any).amount_2 ?? null,
        invoice_number_3: (data as any).invoice_number_3 || "",
        amount_3: (data as any).amount_3 ?? null,
