...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    outline: "bg-transparent border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground/10 h-12 text-base",
    ghost: "bg-secondary text-foreground hover:bg-secondary/80 h-12 text-base",
    white: "bg-background text-foreground hover:bg-background/90 h-12 text-base shadow-lg",
  };
