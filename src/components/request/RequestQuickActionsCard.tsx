...
export function RequestQuickActionsCard({
  ...
  const getStatusStyle = (status: string) => {
    const styles: Record<string, string> = {
      "Новая": "bg-blue-500/15 text-blue-600 dark:text-blue-400 border-blue-500/30",
      "В работе": "bg-amber-500/15 text-amber-600 dark:text-amber-400 border-amber-500/30",
      "На согласовании": "bg-purple-500/15 text-purple-600 dark:text-purple-400 border-purple-500/30",
      "Заказано": "bg-indigo-500/15 text-indigo-600 dark:text-indigo-400 border-indigo-500/30",
      "В пути": "bg-emerald-400/15 text-emerald-500 dark:text-emerald-400 border-emerald-400/30",
      "Доставлено в ТК": "bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-emerald-500/30",
      "Доставлено": "bg-emerald-600/15 text-emerald-700 dark:text-emerald-300 border-emerald-600/30",
