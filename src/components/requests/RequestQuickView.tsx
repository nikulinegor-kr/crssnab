...
export function RequestQuickView({ request, open, onClose, onEdit }: RequestQuickViewProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed top-0 right-0 z-50 h-full w-[420px] max-w-[90vw] bg-background border-l border-border shadow-2xl",
      ...
      >
        ...
        {/* Footer */}
        <div className="absolute bottom-0 left-0 right-0 px-5 py-3 border-t border-border bg-background flex items-center gap-2">
          <Button
