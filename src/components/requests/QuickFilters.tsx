...
const QUICK_FILTERS: QuickFilterButton[] = [
  {
    ...
    activeColor: "bg-destructive text-destructive-foreground border-destructive/30 hover:bg-destructive/90",
    type: "priority",
    value: "Аварийно",
  },
  {
    ...
    activeColor: "bg-warning text-warning-foreground border-warning/30 hover:bg-warning/90",
    type: "priority",
    value: "Приоритетно",
  },
  {
    ...
    activeColor: "bg-info text-background border-info hover:bg-info/90",
    type: "status",
  ...
  },
  {
    ...
    activeColor: "bg-info text-background border-info/30 hover:bg-info/90",
    type: "status",
    value: "В пути",
  },
  {
    ...
    activeColor: "bg-success text-background border-success/30 hover:bg-success/90",
    type: "status",
