...
const MOVEMENT_LABELS: Record<string, { label: string; color: string }> = {
  ...
  MOVE: { label: "Перемещение", color: "bg-info/10 text-info" },
  RETURN: { label: "Возврат", color: "bg-success/10 text-success" },
  ADJUST: { label: "Корректировка", color: "bg-muted text-muted-foreground" },
};
